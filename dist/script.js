...
var accordionJS = function accordionJS(triggerSelector) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunction = function calcFunction() {
    var calcData;
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/calc').then(function (res) {
      return tech(res[0]);
    }).catch(function (error) {
      return console.log(error);
    });

    var tech = function tech(calcData) {
      if (!calcData) {
...
var forms = function forms() {
  ...
  var clearInputs = function clearInputs() {
    ...
    upload.forEach(function (item) {
      item.previousElementSibling.textContent = 'file is unselected';
    });
  };
    ...
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        setTimeout(function () {
          ...
          setTimeout(statusMessage.remove(), 400);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  var btn = document.querySelector(trigger); // carts.forEach(cart => {
